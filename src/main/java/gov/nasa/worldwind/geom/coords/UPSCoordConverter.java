...
public class UPSCoordConverter {
	...
	/**
	 * The function SetUPSParameters receives the ellipsoid parameters and
	...
	/**
	 * The function Convert_UPS_To_Geodetic converts UPS (hemisphere,
	 * easting, and northing) coordinates to geodetic (latitude and
	 * longitude) coordinates according to the current ellipsoid parameters.
	 * If any errors occur, the error code(s) are returned by the function,
