...
class MGRSCoordConverter {
	...
	/**
	 * The function setMGRSParameters receives the ellipsoid parameters and
	 * sets the corresponding state variables. If any errors occur, the
	 * error code(s) are returned by the function, otherwise MGRS_NO_ERROR
	 * is returned.
	 *
	 ...
	 * are returned by the function, otherwise UTM_NO_ERROR is returned.
	 *
	...
	/**
	 * The function Break_MGRS_String breaks down an MGRS coordinate string
	 * into its component parts. Updates last_error.
	 *
	...
	/**
	 * The function Check_Zone receives an MGRS coordinate string. If a zone
	 * is given, MGRS_NO_ERROR is returned. Otherwise, MGRS_NOZONE_WARNING.
	 * is returned.
	 *
	 * @param MGRSString the MGRS coordinate string.
	 *
	 ...
	 * letter and uses the Latitude_Band_Table to determine the minimum
	 * northing for that latitude band letter. Updates min_northing.
	 *
	...
	/**
	 * The function Get_Latitude_Range receives a latitude band letter and
	 * uses the Latitude_Band_Table to determine the latitude band
	...
	/**
	 * The function convertMGRSToUTM converts an MGRS coordinate string to
	 * UTM projection (zone, hemisphere, easting and northing) coordinates
	 * according to the current ellipsoid parameters. Updates last_error if
	 * any errors occured.
	 *
	 * @param MGRSString the MGRS coordinate string
	 *
...
//                false_northing = UPS_Constant_Table.get((int) letters[0]).false_northing;
	...
	/**
	 * The function UTM_To_MGRS calculates an MGRS coordinate string based
	 * on the zone, latitude, easting and northing.
	 *
	 ...
	 * letter in the MGRS coordinate string, based on the set number of the
	 * utm zone. It also sets the false northing using a value of A for the
	 * second letter of the grid square, based on the grid pattern and set
	...
	/**
	 * The function Get_Latitude_Letter receives a latitude value and uses
	 * the Latitude_Band_Table to determine the latitude band letter for
	 * that latitude.
	 *
	...
	/**
	 * The function Round_MGRS rounds the input value to the nearest
	 * integer, using the standard engineering rule. The rounded integer
	 ...
	 * to UPS (hemisphere, easting, and northing) coordinates, according to
	 * the current ellipsoid parameters. If any errors occur, the error
	 * code(s) are returned by the function, otherwide UPS_NO_ERROR is
	 * returned.
	 *
