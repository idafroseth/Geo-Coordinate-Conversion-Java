...
class TMCoordConverter {
	 ...
	 * parameters and Tranverse Mercator projection parameters as inputs,
	 * and sets the corresponding state variables. If any errors occur, the
	 * error code(s) are returned by the function, otherwise
	 * TRANMERC_NO_ERROR is returned.
	 *
	...
	/**
	 * The function Convert_Geodetic_To_Transverse_Mercator converts
	 * geodetic (latitude and longitude) coordinates to Transverse Mercator
	 * projection (easting and northing) coordinates, according to the
	 * current ellipsoid and Transverse Mercator projection coordinates. If
	...
	/**
	 * The function Convert_Transverse_Mercator_To_Geodetic converts
	 * Transverse Mercator projection (easting and northing) coordinates to
	 * geodetic (latitude and longitude) coordinates, according to the
	 * current ellipsoid and Transverse Mercator projection parameters. If
	 * any errors occur, the error code(s) are returned by the function,
	 * otherwise TRANMERC_NO_ERROR is returned.
	 *
