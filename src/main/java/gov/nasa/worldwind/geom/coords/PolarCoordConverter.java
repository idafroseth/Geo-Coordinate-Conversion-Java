...
public class PolarCoordConverter {
	 ...
	 * parameters and Polar Stereograpic projection parameters as inputs,
	 * and sets the corresponding state variables. If any errors occur,
	 * error code(s) are returned by the function, otherwise POLAR_NO_ERROR
	 * is returned.
	 *
