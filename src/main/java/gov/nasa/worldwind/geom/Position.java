...
public class Position extends LatLon {
	 ...
	 * interpolation factor <code>amount</code> defines the weight given to
	 * each value, and is clamped to the range [0, 1]. If <code>a</code> is
	 * 0 or less, this returns <code>value1</code>. If <code>amount</code>
	 * is 1 or more, this returns <code>value2</code>. Otherwise, this
	 * returns the position on the great-arc between <code>value1</code> and
	 * <code>value2</code> with a linearly interpolated elevation component,
	 * and corresponding to the specified interpolation factor.
	 *
	 * @param amount the interpolation factor
	 * @param value1 the first position.
	 * @param value2 the second position.
	 ...
	 * 0 or less, this returns <code>value1</code>. If <code>amount</code>
	 * is 1 or more, this returns <code>value2</code>. Otherwise, this
	 * returns the position on the rhumb line between <code>value1</code>
	 * and <code>value2</code> with a linearly interpolated elevation
	 * component, and corresponding to the specified interpolation factor.
	 *
	 * @param amount the interpolation factor
	 * @param value1 the first position.
	 * @param value2 the second position.
	 ...
	 *
	 * @return the translated positions, or null if the positions could not
	 * be translated.
	 *
