...
public class Frustum {
	...
	/**
	 * Create a frustum from six {@link gov.nasa.worldwind.geom.Plane}s
	 * defining the frustum boundaries.
	 * <p/>
	 ...
	 *
	 * @return an array of the frustum planes, in the order left, right,
	 * bottom, top, near, far.
	 */
	...
	// ============== Factory Functions ======================= //
	/**
	 * Creates a frustum by extracting the six frustum planes from a
	 * projection matrix.
	 *
	...
	/**
	 * Creates a <code>Frustum</code> from a horizontal field-of-view,
	 * viewport aspect ratio and distance to near and far depth clipping
	 * planes. The near plane must be closer than the far plane, and both
	 * near and far values must be positive.
	 *
	 * @param horizontalFieldOfView horizontal field-of-view angle in the
	 * range (0, 180)
	 ...
	 *
	 * @throws IllegalArgumentException if fov is not in the range (0, 180),
	 * if either near or far are negative, or near is greater than or equal
	 * to far
	 */
	 ...
	 *
	 * @return a Frustum configured with the specified perspective
	 * parameters.
	 *
	 * @throws IllegalArgumentException if the difference of any plane set
	 * (lright - left, top - bottom, far - near) is less than or equal to
	 * zero.
	 */
	...
	/**
	 * Creates a <code>Frustum</code> from four edge vectors, viewport
	 * aspect ratio and distance to near and far planes. The edge vectors
	 * connect the near corners of the frustum to the far corners. The near
	 * plane must be closer than the far plane, and both planes must be
	 * positive.
	 *
	 ...
	 * either near or far are negative, or near is greater than or equal to
	 * far
	 */
	 ...
	 *
	 * @return true if the segment intersects or is contained in the
	 ...
	 * @param extent the Extent to test.
	 *
	 * @return true if the extent is fully within this frustum, otherwise
	 * false.
	 *
	 * @throws IllegalArgumentException if the extent is null.
	 */
