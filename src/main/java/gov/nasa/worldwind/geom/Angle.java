...
public class Angle implements Comparable<Angle> {
	 ...
	 * @param minutes integer number of minutes, positive only between 0 and
	 * 60.
	 * @param seconds integer number of seconds, positive only between 0 and
	 * 60.
	 *
	 * @return a new angle whose size in degrees is given by
	 * <code>degrees</code>, <code>minutes</code> and <code>seconds</code>.
	 *
	 * @throws IllegalArgumentException if minutes or seconds are outside
	 * the 0-60 range.
	 */
	...
	/**
	 * Retrieves the size of this angle in degrees. This method may be
	 * faster than first obtaining the radians and then converting to
	 * degrees.
	 *
	 ...
	 * <code>java.lang.Math</code> functions, which generally take radians
	 * as trigonometric arguments. This method may be faster that first
	 ...
	 *
	 * @return an angle whose size is the total of this angles and angles
	 * size.
	 *
	 ...
	 * argument. This method is not commutative. Neither this angle nor
	 * angle is changed, instead the result is returned as a new angle.
	 *
	 * @param angle the angle to subtract from this angle.
	 *
	 * @return a new angle correpsonding to this angle's size minus angle's
	 * size.
	 *
	 * @throws IllegalArgumentException if angle is null.
	 */
	...
	/**
	 * Divides this angle by <code>divisor</code>. This angle remains
	 * unchanged. The result is returned as a new angle. Behaviour is
	 * undefined if <code>divisor</code> equals zero.
	 *
	 ...
	 *
	 * @return a new angle between <code>value1</code> and
	 * <code>value2</code>.
	 */
	...
	/**
	 * Compares this {@link Angle} with another. Returns a negative integer
	 * if this is the smaller angle, a positive integer if this is the
	 * larger, and zero if both angles are equal.
	 *
	 * @param angle the angle to compare against.
	 *
	 * @return -1 if this angle is smaller, 0 if both are equal and +1 if
	 ...
	 *
	 * @return the value of this angle in degrees and as a
	 * <code>String</code>.
	 */
	@Override
	 ...
	 * {@link Angle}.
	 *
	 * @param digits the number of digits past the decimal point to include
	 * in the string.
	 *
	 * @return the value of this angle in decimal degrees as a string with
	 * the specified number of digits beyond the decimal point. The string
	...
	/**
	 * Obtains a {@link String} representation of this {@link Angle}
	 * formated as degrees, minutes and seconds integer values.
	 *
	 * @return the value of this angle in degrees, minutes, seconds as a
	 * string.
	 */
