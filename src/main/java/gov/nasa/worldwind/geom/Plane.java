...
public final class Plane {
	...
	/**
	 * Constructs a plane from a 4-D vector giving the plane normal vector
	 * and distance.
	 *
	...
	/**
	 * Constructs a plane from four values giving the plane normal vector
	 * and distance.
	 *
	 ...
	 *
	 * @throws IllegalArgumentException if the normal vector components
	 * define the zero vector (all values are zero).
	 */
	 ...
	 * </code>pa</code>, respectively. The returned plane is undefined if
	 * any of the specified points are colinear.
	 *
	 ...
	 *
	 * @throws IllegalArgumentException if <code>pa</code>, <code>pb</code>,
	 * or <code>pc</code> is <code>null</code>.
	 */
	 ...
	 *
	 * @return a 4-D vector indicating the plane's normal vector and
	 * distance.
	 */
	...
	/**
	 * Returns a normalized version of this plane. The normalized plane's
	 * normal vector is unit length and its distance is D/|N| where |N| is
	 * the length of this plane's normal vector.
	 *
	...
	/**
	 * Determine the parametric point of intersection of a line with this
	 * plane.
	 *
	 * @param line the line to test
	 *
	 * @return The parametric value of the point on the line at which it
	 * intersects the plane. {@link Double#NaN} is returned if the line does
	 * not intersect the plane. {@link Double#POSITIVE_INFINITY} is returned
	 * if the line is coincident with the plane.
	 *
	 * @throws IllegalArgumentException if the line is null.
	 */
	...
	/**
	 * Test a line segment for intersection with this plane. If it
	 * intersects, return the point of intersection.
	 *
	 * @param pa the first point of the line segment.
	 * @param pb the second point of the line segment.
	 *
	 * @return The point of intersection with the plane. Null is returned if
	 * the segment does not instersect this plane.
	 * {@link gov.nasa.worldwind.geom.Vec4#INFINITY} coincident with the
	 * plane.
	 *
	 ...
	 *
	 * @return An array of two points both on the positive side of the
	 * plane. If the direction of the line formed by the two points is
	 * positive with respect to this plane's normal vector, the first point
	 * in the array will be the intersection point on the plane, and the
	 * second point will be the original segment end point. If the direction
	 ...
	 * point, and the second point will be the intersection point on the
	 * plane. If the segment does not intersect the plane, null is returned.
	 * If the segment is coincident with the plane, the input points are
	 ...
	 * @param pb the second point.
	 *
	 * @return true if the points are on the same side of the plane,
	 * otherwise false.
	 *
	 ...
	 * otherwise false.
	 *
	 * @throws IllegalArgumentException if the points array is null or any
	 * point within it is null.
	 */
