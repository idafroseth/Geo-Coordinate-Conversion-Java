...
public class Quaternion {
	...
	/**
	 * Returns a Quaternion created from three Euler angle rotations. The
	 * angles represent rotation about their respective unit-axes. The
	 * angles are applied in the order X, Y, Z. Angles can be extracted by
	 * calling
	 ...
	 * @return Quaternion representing combined latitude and longitude
	 * rotation.
	 */
