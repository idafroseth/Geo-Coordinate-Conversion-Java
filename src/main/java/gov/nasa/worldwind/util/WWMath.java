...
public class WWMath {
	...
	/**
	 * Returns the value that is the nearest power of 2 greater than or
	 * equal to the given value.
	 *
	 * @param reference the reference value. The power of 2 returned is
	 * greater than or equal to this value.
	 *
	 * @return the value that is the nearest power of 2 greater than or
	...
	/**
	 * Returns the value that is the nearest power of 2 less than or equal
	 * to the given value.
	 *
	 * @param reference the reference value. The power of 2 returned is less
	 * than or equal to this value.
	 *
	 * @return the value that is the nearest power of 2 less than or equal
	 ...
	 *
	 * @return an array containing the requested values. Each element
	 * contains the value b^i, where b is the base and i is the element
	 * number (0, 1, etc.).
	 */
	...
	/**
	 * Returns the interpolation factor for <code>v</code> given the
	 * specified range <code>[x, y]</code>. The interpolation factor is a
	 * number between 0 and 1 (inclusive), representing the value's relative
	 * position between <code>x</code> and <code>y</code>. For example, 0
	 * corresponds to <code>x</code>, 1 corresponds to <code>y</code>, and
	 * anything in between corresponds to a linear combination of
	 ...
	 *
	 * @return the interpolation factor for <code>v</code> given the
	 * specified range <code>[x, y]</code>
	 */
	 ...
	 * <code>a</code> is 0 or less, this returns x. If <code>a</code> is 1
	 * or more, this returns <code>y</code>. Otherwise, this returns the
	 * linear interpolation of <code>x</code> and <code>y</code>. For
	 * example, when <code>a</code> is <code>0.5</code> this returns
	 * <code>(x + y)/2</code>.
	 *
	 ...
	 * @param y the second value.
	 *
	 * @return the linear interpolation of <code>x</code> and
	 * <code>y</code>.
	 */
	 ...
	 * - t) * x + t * y</code>, where <code>t = a * a * (3 - 2 * a)</code>.
	 * The interpolation factor <code>a</code> defines the weight given to
	 * each value, and is clamped to the range [0, 1]. If <code>a</code> is
	 * 0 or less, this returns <code>x</code>. If <code>a</code> is 1 or
	 * more, this returns <code>y</code>. Otherwise, this returns the smooth
	 * hermite interpolation of <code>x</code> and <code>y</code>. Like the
	 * linear function {@link #mix(double,
	 * double, double)}, when <code>a</code> is <code>0.5</code> this
	 * returns <code>(x + y)/2</code>. But unlike the linear function, the
	 * hermite function's slope gradually increases when <code>a</code> is
	 * near 0, then gradually decreases when <code>a</code> is near 1. This
	 * is a useful property where a more gradual transition from
