...
public interface AVList {
	...
	/**
	 * Adds a key/value pair to the list. Replaces an existing key/value
	 * pair if the list already contains the key.
	 *
	 * @param key the attribute name. May not be <code>null</code>.
	 * @param value the attribute value. May be <code>null</code>, in which
	 * case any existing value for the key is removed from the collection.
	 *
	 ...
	 * Replaces an existing key/value pair if the list already contains the
	 * key.
	 *
	 ...
	 *
	 * @throws NullPointerException if <code>avList</code> is
	 * <code>null</code>.
	 */
	 ...
	 * @param key the attribute name. May not be <code>null</code>.
	 *
	 * @return the attribute value if one exists in the collection,
	 ...
	 * @throws NullPointerException if <code>key</code> is
	 * <code>null</code>.
	 * @throws gov.nasa.worldwind.exception.WWRuntimeException if the value
	 * in the collection is not a <code>String</code> type.
	 */
	String getStringValue(String key) throws Exception;
	 ...
	 * @param key the attribute name. May not be <code>null</code>.
	 *
	 * @return <code>true</code> if the key exists in the collection,
	...
	/**
	 * Removes a specified key from the collection if the key exists,
	 * otherwise returns without affecting the collection.
	 *
	 * @param key the attribute name. May not be <code>null</code>.
	 *
	 * @return previous value associated with specified key, or null if
	 ...
	 *
	 * @throws IllegalArgumentException if either <code>propertyName</code>
	 * or <code>listener</code> is null
	...
	/**
	 * Calls all property change listeners associated with the specified
	 * key. No listeners are called if <code>odValue</code> and
	 * <code>newValue</code> are equal and non-null.
	 *
	 * @param propertyName the key
	 * @param oldValue the value associated with the key before the even
	 * causing the firing.
	 ...
	 *
	 * @throws IllegalArgumentException if <code>propertyChangeEvent</code>
	 * is null
	 * @see java.beans.PropertyChangeSupport
	 */
	...
	/**
	 * Returns a shallow copy of this <code>AVList</code> instance: the keys
